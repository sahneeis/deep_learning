...
class DecoderBlock(nn.Module):
    ...
    def forward(self,
        ...
        attention_output = self.causal_multi_head(inputs, inputs, inputs, causal_mask)
        outputs = self.layer_norm1(inputs + attention_output)

        # Step 2: Cross-Attention
        cross_attention_output = self.cross_multi_head(outputs, context, context, pad_mask)
        outputs = self.layer_norm2(outputs + cross_attention_output)
