...
class Autoencoder(nn.Module):
    ...
    def set_optimizer(self):
        ...
        self.optimizer = torch.optim.Adam(self.parameters(), lr=self.hparams["ae_learning_rate"])
...
class Classifier(nn.Module):
    ...
    def __init__(self, hparams, encoder):
        ...
        output_size = 10
        hidden_size_1 = self.hparams["cls_hidden_size_1"]
        hidden_size_2 = self.hparams["cls_hidden_size_2"]
        activation = self.hparams["cls_activation"]
        self.model = nn.Sequential(
            nn.Linear(latent_dim, hidden_size_1),
            activation(),
    ...
    def set_optimizer(self):
        ...
        self.optimizer = torch.optim.Adam(self.parameters(), lr=self.hparams["cls_learning_rate"])
